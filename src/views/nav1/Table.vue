<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="goodscount" label="库存" width="100"  sortable>
			</el-table-column>
			<el-table-column prop="goodsprice" label="价格" width="100" sortable>
			</el-table-column>
		...
		methods: {
			...
			inOrOutSubmit:function(){
				...
				this.$refs.inoroutForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认'+_this.editForm.goodsname+_this.inorout+_this.inoroutCount+'个吗？', '提示', {}).then(() => {
